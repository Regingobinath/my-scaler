...
import com.restaurant.dtos.GetMenuItemsRequestDto;
import com.restaurant.dtos.GetMenuItemsResponseDto;
import com.restaurant.dtos.ResponseStatus;
import com.restaurant.models.DietaryRequirement;
import com.restaurant.models.ItemType;
...
public class TestMenuControllers {
    ...
    private void initializeRepositories() throws Exception {
        Reflections repositoryReflections = new Reflections(MenuItemRepository.class.getPackageName(), new SubTypesScanner(false));
        this.menuRepository = createInstance(MenuItemRepository.class, repositoryReflections);
    }
